<?php
if (!function_exists('curly_mkdf_init_google_fonts_array')) {
    function curly_mkdf_init_google_fonts_array() {
        ...
        $curly_mkdf_fonts_array = $google_fonts_decoded['items'];
    }

    add_action('after_setup_theme', 'curly_mkdf_init_google_fonts_array');
}